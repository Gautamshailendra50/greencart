    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all z-50">
            ...
            <div className="hidden md:flex items-center gap-6 ml-7">
                ...
                <NavLink to="/seller" className="relative overflow-hidden h-6 group">
                    <span className="block group-hover:-translate-y-full transition-transform duration-300">Seller Dashboard</span>
                    <span className="block absolute top-full left-0 group-hover:translate-y-[-100%] transition-transform duration-300">Seller Dashboard</span>
                </NavLink>
